...
/**
 * Detects the colour of a traffic light using the SwiftBots camera.
...
public class TrafficLightColourDetector {
    ...
    // Slightly higher for blue to account for ambient light issues
     ...
     * @return an int array containing the average [red, green, blue] values 0-255.
     */
     ...
     * other colourss stay below their corresponding non-dominant maximums.
